...
if !exists('*SetPythonOptions')
    function! SetPythonOptions()
        ...
        setlocal smartindent et sts=4 sw=4 tw=80 fo=croq
...
augroup python_auto
    ...
    autocmd BufRead,Bufnewfile *.py im :<CR> :<CR><TAB>
    autocmd BufWritePost *.py :silent !chmod a+x <afile>
augroup END
