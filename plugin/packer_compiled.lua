...
_G.packer_plugins = {
  ...
  ["doom-vibrant.nvim"] = {
    ...
    url = "https://github.com/shaunsingh/doom-vibrant.nvim"
  },
  everforest = {
    loaded = true,
...
try_loadstring("\27LJ\2\0022\0\0\2\0\2\0\0046\0\0\0'\1\1\0B\0\2\1K\0\1\0\23plugins.config.cmp\frequire\0", "config", "LuaSnip")
